...
# include "class_scsp_active_2phi_D2Q9.cuh"
...
class_scsp_active_2phi_D2Q9::class_scsp_active_2phi_D2Q9()
{
	Q = 9;
...
void class_scsp_active_2phi_D2Q9::allocate()
{
...
void class_scsp_active_2phi_D2Q9::deallocate()
{
...
void class_scsp_active_2phi_D2Q9::memcopy_host_to_device()
{
...
void class_scsp_active_2phi_D2Q9::memcopy_device_to_host()
{
...
void class_scsp_active_2phi_D2Q9::create_lattice_box_periodic()
{
...
void class_scsp_active_2phi_D2Q9::stream_index_pull()
{
...
void class_scsp_active_2phi_D2Q9::setU(int i, float val)
{
	uH[i].x = val;
}

void class_scsp_active_2phi_D2Q9::setV(int i, float val)
{
	uH[i].y = val;
}

void class_scsp_active_2phi_D2Q9::setPx(int i, float val)
{
	pH[i].x = val;
}

void class_scsp_active_2phi_D2Q9::setPy(int i, float val)
{
	pH[i].y = val;
}

void class_scsp_active_2phi_D2Q9::setR(int i, float val)
{
	rH[i] = val;
}

void class_scsp_active_2phi_D2Q9::setPhi1(int i, float val)
{
	phi1H[i] = val;
}

void class_scsp_active_2phi_D2Q9::setPhi2(int i, float val)
{
	phi2H[i] = val;
}

void class_scsp_active_2phi_D2Q9::setVoxelType(int i, int val)
{
	voxelTypeH[i] = val;
}
...
float class_scsp_active_2phi_D2Q9::getU(int i)
{
	return uH[i].x;
}

float class_scsp_active_2phi_D2Q9::getV(int i)
{
	return uH[i].y;
}

float class_scsp_active_2phi_D2Q9::getR(int i)
{
	return rH[i];
}

float class_scsp_active_2phi_D2Q9::getPhi1(int i)
{
	return phi1H[i];
}

float class_scsp_active_2phi_D2Q9::getPhi2(int i)
{
	return phi2H[i];
}
...
void class_scsp_active_2phi_D2Q9::initial_equilibrium(int nBlocks, int nThreads)
{
...
void class_scsp_active_2phi_D2Q9::zero_forces(int nBlocks, int nThreads)
{
...
void class_scsp_active_2phi_D2Q9::stream_collide_save(int nBlocks, int nThreads)
{
...
void class_scsp_active_2phi_D2Q9::stream_collide_save_forcing(int nBlocks, int nThreads)
{
...
void class_scsp_active_2phi_D2Q9::scsp_active_update_orientation(int nBlocks, int nThreads)
{
...
void class_scsp_active_2phi_D2Q9::scsp_active_update_orientation_diffusive(int nBlocks, int nThreads)
{
...
void class_scsp_active_2phi_D2Q9::scsp_active_fluid_stress(int nBlocks, int nThreads)
{
...
void class_scsp_active_2phi_D2Q9::scsp_active_fluid_forces(int nBlocks, int nThreads)
{
...
void class_scsp_active_2phi_D2Q9::scsp_active_fluid_molecular_field(int nBlocks, int nThreads)
{
...
void class_scsp_active_2phi_D2Q9::scsp_active_fluid_molecular_field_with_phi(int nBlocks, int nThreads)
{
...
// --------------------------------------------------------
// Call to "scsp_active_fluid_chemical_potential_2phi_D2Q9" kernel:
// --------------------------------------------------------

void class_scsp_active_2phi_D2Q9::scsp_active_fluid_chemical_potential(int nBlocks, int nThreads)
{
	scsp_active_fluid_chemical_potential_2phi_D2Q9 
	<<<nBlocks,nThreads>>> (phi1,phi2,chempot1,chempot2,p,nList,a,alpha,kapphi,beta,nVoxels);
}



// --------------------------------------------------------
// Call to "scsp_active_fluid_capillary_force_2phi_D2Q9" kernel:
// --------------------------------------------------------

void class_scsp_active_2phi_D2Q9::scsp_active_fluid_capillary_force(int nBlocks, int nThreads)
{
	scsp_active_fluid_capillary_force_2phi_D2Q9 
	<<<nBlocks,nThreads>>> (phi1,phi2,chempot1,chempot2,F,nList,nVoxels);
}



// --------------------------------------------------------
// Call to "scsp_active_fluid_update_phi_2phi_D2Q9" kernel:
// --------------------------------------------------------

void class_scsp_active_2phi_D2Q9::scsp_active_fluid_update_phi(int nBlocks, int nThreads)
{
	scsp_active_fluid_update_phi_2phi_D2Q9 
	<<<nBlocks,nThreads>>> (phi1,phi2,chempot1,chempot2,u,nList,mob,nVoxels);
}
...
void class_scsp_active_2phi_D2Q9::scsp_active_fluid_update_phi_diffusive(int nBlocks, int nThreads)
{
...
void class_scsp_active_2phi_D2Q9::scsp_active_fluid_set_velocity_field(int nBlocks, int nThreads)
{
