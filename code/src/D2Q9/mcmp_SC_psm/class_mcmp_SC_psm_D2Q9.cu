...
# include "class_mcmp_SC_psm_D2Q9.cuh"
# include "../../IO/GetPot"
# include <math.h>
using namespace std;  
...
class_mcmp_SC_psm_D2Q9::class_mcmp_SC_psm_D2Q9()
{
	Q = 9;
...
void class_mcmp_SC_psm_D2Q9::allocate()
{
...
void class_mcmp_SC_psm_D2Q9::deallocate()
{
...
void class_mcmp_SC_psm_D2Q9::memcopy_host_to_device()
{
...
void class_mcmp_SC_psm_D2Q9::memcopy_device_to_host()
{
...
void class_mcmp_SC_psm_D2Q9::create_lattice_box()
{
	GetPot inputParams("input.dat");	
...
void class_mcmp_SC_psm_D2Q9::create_lattice_box_periodic()
{
...
void class_mcmp_SC_psm_D2Q9::create_lattice_file()
{
...
void class_mcmp_SC_psm_D2Q9::stream_index_push()
{
...
void class_mcmp_SC_psm_D2Q9::stream_index_pull()
{
...
void class_mcmp_SC_psm_D2Q9::read_iolet_info(int i, const char* name) 
{
	char namemod[20];
	GetPot inputParams("input.dat");
...
void class_mcmp_SC_psm_D2Q9::swap_populations()
{
	float* tempA = f1A;
	float* tempB = f1B;
	f1A = f2A;
...
void class_mcmp_SC_psm_D2Q9::setU(int i, float val)
{
	uH[i] = val;
}

void class_mcmp_SC_psm_D2Q9::setV(int i, float val)
{
	vH[i] = val;
}

void class_mcmp_SC_psm_D2Q9::setX(int i, int val)
{
	xH[i] = val;
}

void class_mcmp_SC_psm_D2Q9::setY(int i, int val)
{
	yH[i] = val;
}

void class_mcmp_SC_psm_D2Q9::setRA(int i, float val)
{
	rAH[i] = val;
}

void class_mcmp_SC_psm_D2Q9::setRB(int i, float val)
{
	rBH[i] = val;
}

void class_mcmp_SC_psm_D2Q9::setVoxelType(int i, int val)
{
	voxelTypeH[i] = val;
}
...
float class_mcmp_SC_psm_D2Q9::getU(int i)
{
	return uH[i];
}

float class_mcmp_SC_psm_D2Q9::getV(int i)
{
	return vH[i];
}

float class_mcmp_SC_psm_D2Q9::getRA(int i)
{
	return rAH[i];
}

float class_mcmp_SC_psm_D2Q9::getRB(int i)
{
	return rBH[i];
}
...
void class_mcmp_SC_psm_D2Q9::initial_equilibrium_psm(int nBlocks, int nThreads)
{
	mcmp_initial_equilibrium_psm_D2Q9 
	<<<nBlocks,nThreads>>> (f1A,f1B,rA,rB,u,v,nVoxels);	
}

void class_mcmp_SC_psm_D2Q9::compute_density_psm(int nBlocks, int nThreads)
{
	mcmp_compute_density_psm_D2Q9
	<<<nBlocks,nThreads>>> (f1A,f1B,rA,rB,nVoxels);
}

void class_mcmp_SC_psm_D2Q9::update_particles_on_lattice_psm(float* prx, float* pry, float* B, 
...
void class_mcmp_SC_psm_D2Q9::compute_SC_forces_psm(float* B, float* pfx, float* pfy, int* pIDgrid, 
...
void class_mcmp_SC_psm_D2Q9::compute_velocity_psm(float* pvx, float* pvy, float* pfx, float* pfy, 
...
void class_mcmp_SC_psm_D2Q9::set_boundary_velocity_psm(int nBlocks, int nThreads)
{
	mcmp_set_boundary_velocity_psm_D2Q9 
	<<<nBlocks,nThreads>>> (rA,rB,FxA,FxB,FyA,FyB,u,v,y,Ny,nVoxels);
}

void class_mcmp_SC_psm_D2Q9::collide_stream_psm(float* pvx, float* pvy, float* B, int* pIDgrid, 
...
void class_mcmp_SC_psm_D2Q9::write_output(std::string tagname, int step)
{
