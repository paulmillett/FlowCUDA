...
class_scsp_D2Q9::class_scsp_D2Q9()
{
	Q = 9;
...
void class_scsp_D2Q9::allocate_forces()
{
...
void class_scsp_D2Q9::allocate_IB_velocities()
{
	// allocate force arrays (device):
...
void class_scsp_D2Q9::deallocate()
{
...
void class_scsp_D2Q9::memcopy_host_to_device()
{
...
void class_scsp_D2Q9::memcopy_host_to_device_iolets()
{
	cudaMemcpy(iolets, ioletsH, sizeof(iolet2D)*numIolets, cudaMemcpyHostToDevice);
}
...
void class_scsp_D2Q9::memcopy_device_to_host()
{
...
void class_scsp_D2Q9::create_lattice_box()
{
	GetPot inputParams("input.dat");
...
void class_scsp_D2Q9::create_lattice_box_periodic()
{
	GetPot inputParams("input.dat");
	Nx = inputParams("Lattice/Nx",1);
	Ny = inputParams("Lattice/Ny",1);
...
void class_scsp_D2Q9::create_lattice_file()
{
...
void class_scsp_D2Q9::stream_index_push()
{
...
void class_scsp_D2Q9::stream_index_pull()
{
...
void class_scsp_D2Q9::read_iolet_info(int i, const char* name) 
{
	char namemod[20];
	GetPot inputParams("input.dat");
...
void class_scsp_D2Q9::setU(int i, float val)
{
	uH[i] = val;
}

void class_scsp_D2Q9::setV(int i, float val)
{
	vH[i] = val;
}

void class_scsp_D2Q9::setR(int i, float val)
{
	rH[i] = val;
}

void class_scsp_D2Q9::setVoxelType(int i, int val)
{
	voxelTypeH[i] = val;
}
...
float class_scsp_D2Q9::getU(int i)
{
	return uH[i];
}

float class_scsp_D2Q9::getV(int i)
{
	return vH[i];
}

float class_scsp_D2Q9::getR(int i)
{
	return rH[i];
}
...
void class_scsp_D2Q9::initial_equilibrium(int nBlocks, int nThreads)
{
...
void class_scsp_D2Q9::stream_collide_save(int nBlocks, int nThreads, bool save)
{
...
void class_scsp_D2Q9::stream_collide_save_forcing(int nBlocks, int nThreads)
{
...
void class_scsp_D2Q9::stream_collide_save_IBforcing(int nBlocks, int nThreads)
{
...
void class_scsp_D2Q9::extrapolate_velocity_from_IBM(int nBlocks, int nThreads,
...
void class_scsp_D2Q9::extrapolate_forces_from_IBM(int nBlocks, int nThreads,
...
void class_scsp_D2Q9::interpolate_velocity_to_IBM(int nBlocks, int nThreads,
	                                        float* xIB, float* yIB, float* vxIB,
											float* vyIB, int nNodes)
{
...
void class_scsp_D2Q9::zero_forces(int nBlocks, int nThreads)
{
	if (!forceFlag) cout << "Warning: LBM force arrays have not been initialized" << endl;
...
void class_scsp_D2Q9::zero_forces_with_IBM(int nBlocks, int nThreads)
{
	if (!forceFlag) cout << "Warning: LBM force arrays have not been initialized" << endl;
	if (!velIBFlag) cout << "Warning: IB velocity arrays have not been initialized" << endl;
	scsp_zero_forces_D2Q9
...
void class_scsp_D2Q9::write_output(std::string tagname, int step)
{
	GetPot inputParams("input.dat");
	Nx = inputParams("Lattice/Nx",1);
	Ny = inputParams("Lattice/Ny",1);
