...
void class_ibm2D::allocate_faces()
{
...
void class_ibm2D::memcopy_host_to_device()
{
...
void class_ibm2D::memcopy_device_to_host()
{
...
void class_ibm2D::setXStart(int i, float val)
{
	xH_start[i] = val;
}

void class_ibm2D::setYStart(int i, float val)
{
	yH_start[i] = val;
}

void class_ibm2D::setXEnd(int i, float val)
{
	xH_end[i] = val;
}

void class_ibm2D::setYEnd(int i, float val)
{
	yH_end[i] = val;
}

void class_ibm2D::set_positions_to_start_positions()
{
...
void class_ibm2D::read_ibm_start_positions(std::string tagname)
{
...
void class_ibm2D::read_ibm_end_positions(std::string tagname)
{
...
void class_ibm2D::shift_start_positions(float xsh, float ysh)
{
	for (int i=0; i<nNodes; i++) {
		xH_start[i] += xsh;
		yH_start[i] += ysh;
...
void class_ibm2D::shift_end_positions(float xsh, float ysh)
{
	for (int i=0; i<nNodes; i++) {
		xH_end[i] += xsh;
		yH_end[i] += ysh;
...
void class_ibm2D::initialize_positions_to_start()
{
	for (int i=0; i<nNodes; i++) {
		xH[i] = xH_start[i];
		yH[i] = yH_start[i];
...
void class_ibm2D::write_output(std::string tagname, int tagnum)
{
...
void class_ibm2D::set_reference_node_positions(int nBlocks, int nThreads)
{
...
void class_ibm2D::update_node_ref_position(int nBlocks, int nThreads)
{
...
void class_ibm2D::compute_node_forces(int nBlocks, int nThreads)
{
...
void class_ibm2D::update_node_positions(int nBlocks, int nThreads)
{
