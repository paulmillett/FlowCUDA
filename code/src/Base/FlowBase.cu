...
# include "../Apps/scsp_3D_cylinders_channel.cuh"
# include "../Apps/scsp_3D_cylinder_shear.cuh"
...
# include "../Apps/scsp_3D_rods_duct.cuh"
# include "../Apps/scsp_3D_rods_slit.cuh"
...
FlowBase* FlowBase::FlowObjectFactory(string specifier)
{
	...
	if (specifier == "scsp_3D_cylinders_channel") return new scsp_3D_cylinders_channel();
	if (specifier == "scsp_3D_cylinder_shear") return new scsp_3D_cylinder_shear();
	...
	if (specifier == "scsp_3D_rods_duct") return new scsp_3D_rods_duct();
	if (specifier == "scsp_3D_rods_slit") return new scsp_3D_rods_slit();
