...
# include "mcmp_2D_capbridge_extensional_bb.cuh"
# include "../IO/GetPot"
# include <math.h>
# include <string> 
using namespace std;   
...
mcmp_2D_capbridge_extensional_bb::mcmp_2D_capbridge_extensional_bb() : lbm()
{	
	...
	velInOut = inputParams("LBM/velInOut",0.0);
	widthInOut = inputParams("LBM/widthInOut",0);
	rAbc = inputParams("LBM/rAbc",0.0);
	rBbc = inputParams("LBM/rBbc",1.0);
...
mcmp_2D_capbridge_extensional_bb::~mcmp_2D_capbridge_extensional_bb()
{
	lbm.deallocate();
}
...
void mcmp_2D_capbridge_extensional_bb::initSystem()
{
	...
	lbm.create_lattice_box_enclosed();
...
void mcmp_2D_capbridge_extensional_bb::cycleForward(int stepsPerCycle, int currentCycle)
{
	...
	for (int step=0; step<stepsPerCycle; step++) {
		...
		lbm.set_boundary_extensional_velocity_bb(velInOut,rAbc,rBbc,widthInOut,nBlocks,nThreads);
...
void mcmp_2D_capbridge_extensional_bb::writeOutput(std::string tagname, int step)
{
