...
# include "scsp_3D_iolets_solidwalls.cuh"
# include "../IO/GetPot"
# include <string>
# include <math.h>
using namespace std;  
...
scsp_3D_iolets_solidwalls::scsp_3D_iolets_solidwalls() : lbm()
{		
...
scsp_3D_iolets_solidwalls::~scsp_3D_iolets_solidwalls()
{	
	lbm.deallocate();	
}
...
void scsp_3D_iolets_solidwalls::initSystem()
{
...
void scsp_3D_iolets_solidwalls::cycleForward(int stepsPerCycle, int currentCycle)
{
	...
	for (int step=0; step<stepsPerCycle; step++) {
		...
		lbm.stream_collide_save_solid(nBlocks,nThreads,save);
...
void scsp_3D_iolets_solidwalls::writeOutput(std::string tagname, int step)
{
