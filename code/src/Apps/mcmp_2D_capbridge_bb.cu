...
# include "mcmp_2D_capbridge_bb.cuh"
# include "../IO/GetPot"
# include <math.h>
# include <string> 
using namespace std;   
...
mcmp_2D_capbridge_bb::mcmp_2D_capbridge_bb() : lbm()
{	
...
mcmp_2D_capbridge_bb::~mcmp_2D_capbridge_bb()
{
	lbm.deallocate();
}
...
void mcmp_2D_capbridge_bb::initSystem()
{
...
void mcmp_2D_capbridge_bb::cycleForward(int stepsPerCycle, int currentCycle)
{
...
void mcmp_2D_capbridge_bb::writeOutput(std::string tagname, int step)
{
