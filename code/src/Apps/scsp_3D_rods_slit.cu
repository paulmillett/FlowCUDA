...
scsp_3D_rods_slit::scsp_3D_rods_slit() : lbm(),rods()
{		
...
scsp_3D_rods_slit::~scsp_3D_rods_slit()
{
	lbm.deallocate();
	rods.deallocate();
}
...
void scsp_3D_rods_slit::initSystem()
{
...
void scsp_3D_rods_slit::cycleForward(int stepsPerCycle, int currentCycle)
{
...
void scsp_3D_rods_slit::writeOutput(std::string tagname, int step)
{				
