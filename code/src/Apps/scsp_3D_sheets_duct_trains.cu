...
# include "scsp_3D_sheets_duct_trains.cuh"
# include "../IO/GetPot"
# include <string>
# include <math.h>
using namespace std;  
...
scsp_3D_sheets_duct_trains::scsp_3D_sheets_duct_trains() : lbm(),ibm()
{		
...
scsp_3D_sheets_duct_trains::~scsp_3D_sheets_duct_trains()
{
	lbm.deallocate();
	ibm.deallocate();	
}
...
void scsp_3D_sheets_duct_trains::initSystem()
{
...
void scsp_3D_sheets_duct_trains::cycleForward(int stepsPerCycle, int currentCycle)
{
...
void scsp_3D_sheets_duct_trains::writeOutput(std::string tagname, int step)
{				
...
void scsp_3D_sheets_duct_trains::calcMembraneParams(float Re, float Ca, float Ksmax)
{
	// 'GetPot' object containing input parameters:
	GetPot inputParams("input.dat");
...
void scsp_3D_sheets_duct_trains::calcRefFlux()
{
	// parameters:
...
float scsp_3D_sheets_duct_trains::calcInfSum(float w, float h)
{
	float outval = 0.0;
