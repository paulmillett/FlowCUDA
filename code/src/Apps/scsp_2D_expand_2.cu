...
scsp_2D_expand_2::scsp_2D_expand_2()
{		
...
void scsp_2D_expand_2::initSystem()
{
...
void scsp_2D_expand_2::cycleForward(int stepsPerCycle, int currentCycle)
{
	...
	for (int step=0; step<stepsPerCycle; step++) {
		...
		<<<nBlocksIB,nThreads>>> (xIB,yIB,vxIB,vyIB,uIBvox,vIBvox,weights,Nx,nNodes);
		...
		<<<nBlocksIB,nThreads>>> (xIB,yIB,xIB_start,yIB_start,xIB_end,yIB_end,vxIB,vyIB,cummulativeSteps,nSteps,nNodes);														 
...
void scsp_2D_expand_2::writeOutput(std::string tagname, int step)
{
