...
# include "scsp_3D_capsules_duct_trains_push.cuh"
# include "../IO/GetPot"
# include <string>
# include <math.h>
using namespace std;  
...
scsp_3D_capsules_duct_trains_push::scsp_3D_capsules_duct_trains_push() : lbm(),ibm()
{		
...
scsp_3D_capsules_duct_trains_push::~scsp_3D_capsules_duct_trains_push()
{
	lbm.deallocate();
	ibm.deallocate();	
}
...
void scsp_3D_capsules_duct_trains_push::initSystem()
{
...
void scsp_3D_capsules_duct_trains_push::cycleForward(int stepsPerCycle, int currentCycle)
{
	...
	for (int step=0; step<stepsPerCycle; step++) {
		...
		// update IBM & LBM:
		//ibm.stepIBM_force_one_capsule(lbm,make_float3(0.0,0.000005,0.0),0,nBlocks,nThreads);
		ibm.stepIBM(lbm,nBlocks,nThreads);
...
void scsp_3D_capsules_duct_trains_push::writeOutput(std::string tagname, int step)
{				
...
void scsp_3D_capsules_duct_trains_push::calcMembraneParams(float Re, float Ca, float Ksmax)
{
	// 'GetPot' object containing input parameters:
	GetPot inputParams("input.dat");
...
void scsp_3D_capsules_duct_trains_push::calcRefFlux()
{
	// parameters:
...
float scsp_3D_capsules_duct_trains_push::calcInfSum(float w, float h)
{
	float outval = 0.0;
