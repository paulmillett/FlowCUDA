...
void build_box_lattice_iolets_solid_walls_D3Q19(int,int,int,int,int,int,int,int,int,int,int,int*,int*,int*); 
void build_box_lattice_slit_solid_walls_D3Q19(int,int,int,int,int*,int*,int*);
int voxel_index(int,int,int,int,int,int);
int voxel_index_solid(int,int,int,int,int,int,int*);
int voxel_index_solid_boundary(int,int,int,int,int,int,int*);
